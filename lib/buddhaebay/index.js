...
var getEbayItemCount = function(ItemID, callback){
  console.log("requesting ebay item count ");
  ...
  function(error, results){
    ...
    console.log(results);
    callback(error, results.Item.Quantity);
  });
            ...
            if (ite) {
              ...
              var newi = new Item({
                    ...
                    ebay:{
                      ...
                      image: result.ListingDetails.ViewItemURL,
                      ebaystore: "true",
                      price: ite.ebay.price = result.StartPrice["#"]
                    }
                  })
...
var updateEbayItemCount = function(itemID, quantity, price, callback){
