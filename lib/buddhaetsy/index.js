...
var getAllListings = function(req, res, callback){
  ...
  etsy.auth().get(
    ...
    function(err, status, body, headers){
      var newi = new Item({name: body.title, stock: body.quantity, image: "https://img0.etsystatic.com/048/0/10392050/il_570xN.704444582_poqv.jpg", owner: "54908d73f65054d8285b967e", 
